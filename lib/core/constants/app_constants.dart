class AppConstants {
  ...
  // Google APIs (replace with your keys; avoid committing secrets)
  static const String googlePlacesApiKey = 'AIzaSyCvh_4Mk1H7AN7UaFmV5qqXVT-vWqJOe8k';
  /// Country code for Places autocomplete (e.g. pk, us)
  static const String placesCountryCode = 'pk';
  ...
  // Storage Keys (SharedPreferences - used for login persistence)
