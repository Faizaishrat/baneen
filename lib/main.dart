import 'package:baneen/controller/passenger_register_provider.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => DriverRegisterProvider(),
        ),
        ChangeNotifierProvider(
          create: (_) => PassengerRegisterProvider(),
        ),
        ChangeNotifierProvider(
